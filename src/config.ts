...
export const SITE: Site = {
  ...
  description:
    "Hi, I'm Kevin Thompson, an engineering manager, full-stack software developer and game designer from Southern California. I create web applications, video games and educational content using a variety of tools and technologies.",
