...
<img src={twilioHackPackInstructionsImage.src} alt="A table showing valid SMS messages for the Twilio hackpack" />
...
```
<img src={twilioVideoWallSuccessImage.src} alt="A text message exchange between a person and the twilio video wall server" />
...
<img src={twilioVideoWallMultipleImage.src} alt="A text message exchange with multiple commands between a person and the twilio video wall server" />
...
ruby display.rb link.png
```
<img src={twilioVideoWallLinkImage.src} alt="A photo of the Twilio video wall displaying pixel art of Link" />
