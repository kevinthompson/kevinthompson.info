...
<img src={sprite2dCreatePolygonImage.src} alt="Sprite2D node dropdown in Godot editor" />

Clicking on that option brings up a modal that will allow you to customize and then create your `CollisionPolygon2D` node.

<img src={godotCollisionModalImage.src} alt="Godot editor CollisionPolygon2D modal" />
